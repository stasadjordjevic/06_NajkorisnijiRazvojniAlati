...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Slike/koriscenje_razvojih_alata_spojeno.png}
...
Na osnovu podataka prikazanih na slici \ref{fig:iskustvo_promena}, analizirana je spremnost ispitanika da promene svoj primarni razvojni alat u zavisnosti od akumuliranog radnog iskustva. Kako bi se jasnije uočili trendovi, podaci su grupisani u tri ključne kategorije, a rezultati ukazuju na sledeće:

\begin{itemize}
    \item \textbf{Manje od 5 godina iskustva:} Ova objedinjena grupa (koja obuhvata početnike i programere sa 3--5 godina staža) predstavlja najbrojniji deo uzorka. Primećuje se umerena podeljenost u navikama: od ukupno 23 ispitanika, 11 je promenilo alat, dok je 12 ostalo pri prvobitnom izboru. Ovo sugeriše da se u ranoj fazi karijere navike tek formiraju.
    
    \item \textbf{Srednji nivo (6--9 godina iskustva):} Kod ovih ispitanika uočen je visok stepen prilagođavanja trendovima. Većina programera u ovoj grupi (9 od ukupno 14) odlučila se za promenu primarnog alata, što ukazuje na svest o potrebi za modernizacijom radnog procesa u zrelijoj fazi karijere.
    
    \item \textbf{Iskusni kadar (10+ godina iskustva):} Grupa sa najdužim stažom pokazuje najveću proaktivnost. Od 6 ispitanika, čak 5 je prešlo na novo okruženje. Ovakav rezultat opovrgava stereotip o rigidnosti iskusnijih programera i potvrđuje da veterani industrije najbrže prepoznaju i usvajaju alate koji donose konkretnu uštedu vremena ili napredne funkcije.
\end{itemize}

Ukupni podaci sugerišu da akumulacija radnog staža (posebno preko 6 godina) korelira sa većom verovatnoćom promene alata. Razlog za ovakav trend verovatno leži u kompleksnosti projekata koji zahtevaju naprednije ekosisteme, kao i u integraciji novih tehnologija poput veštačke inteligencije u modernim razvojnim okruženjima.
...
\begin{itemize}
    ...
    \item \textbf{Problemi i ograničenja:} Kritike su jasno podeljene prema tipu alata. Kod kompleksnijih okruženja poput \textit{Visual Studio}-a i \textit{IntelliJ}-a, korisnici se najviše žale na veliku potrošnju memorije (RAM) i prisustvo ,,nepotrebnih opcija'' koje opterećuju rad. Nasuprot tome, korisnici lakših editora (VSC) uočavaju nedostatke u naprednim funkcijama, kao što su slabija signalizacija grešaka u poređenju sa punim IDE rešenjima, problemi sa C++ podrškom, ili povremeni otkaz funkcije ,,Go to Definition''. 
...
Ovi odgovori potvrđuju da, iako je univerzalnost bitna, programeri visoko vrednuju specijalizaciju alata za konkretne zadatke i da su spremni da tolerišu hardversku zahtevnost ukoliko ona donosi značajnu uštedu u vremenu prilikom debagovanja i navigacije kroz kompleksne projekte.
