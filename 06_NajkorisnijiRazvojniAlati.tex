% !TeX root = 06_NajkorisnijiRazvojniAlati.tex
...
\begin{figure}[H] % [H] fiksira sliku tačno ovde
    \centering
    \includegraphics[width=1\textwidth]{slike file/koji_faktori_su_najbitniji_kirosnicima_razlicitih_alata.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{slike file/koriscenje_razvojnih_alata_ide_prema_polu.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{slike file/github_vs_gitlab_korisnici_intellij.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{slike file/odnos_promene_razvojnog_alata_i_radnog_iskustva.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{slike file/vaznost_faktora_u_odnosu_na_tekstualne_editore.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{slike file/matf_sta_mu_najbitnije.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{slike file/fon_sta_mu_najbitnije.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{slike file/raf_sta_mu_najbitnije.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{slike file/studenti_sta_im_najbitnije.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{slike file/zaposleni_sta_mu_najbitnije.png}
