...
\begin{itemize}
    ...
    \odgovor{Odlučeno je da se izbaci ceo deo ovog odeljka koji je samo prepričavao ono što se moglo uočiti na grafiku (slika 2, strana 6). Zadržan je samo kraći pasus koji izvodi najvažnije zaključke.}
\end{itemize}
...
\begin{itemize}
    ...
    \odgovor{Odeljak je preimenovan u \textbf{Kriterijumi pri izboru alata} i dodatno je navedeno u prvom pasusu koji su to kriterijumi ispitani.}
    ...
    \odgovor{Odeljak je preimenovan u \textbf{Uticaj radnog iskustva na zamenu razvojnog alata} i prva rečenica je promenjena u ``U ovom delu istraživanja analizira se korelacija između dužine radnog staža ispitanika i njihove tendencije ka prelasku sa jednog na drugi primarni razvojni alat''.}
    ...
    \odgovor{Rečenica je preformulisana u ``Analizirana je veza između ocene uticaja navike na izbor razvojnog alata i odgovora ispitanika na pitanje da li su u prethodnom periodu menjali svoj primarni alat.'' Pored toga, ceo odeljak je dodatno stilski dorađen kako bi se poboljšala jasnoća i čitljivost teksta.}
\end{itemize}
...
\odgovor{Sugestija je prihvaćena i naslov rada je izmenjen u \textbf{Najkorišćeniji razvojni alati}.}
...
\odgovor{Sažetak je u celosti promenjen u skladu sa navedenim sugestijama. Sada se na razumljiv i direktan način iskazuju svrha i suština rada, kao i motivacija za izvršeno istraživanje i dobijeni rezultati.}
...
\odgovor{Pojačano je isticanje bitnih pojmova, a korišćenje italic fonta je ujednačeno radi konzistentnosti.}   
...
\odgovor{Sporan časopis je izbačen iz liste korišćene literature, a umesto njega, iskoriščen je časopis koji se ne nalazi na Beall's listi potencijalno predatorskih časopisa (``Asian Journal of Engineering and Applied Technology''). Naveden je pod rednim brojem 7 u literaturi. Takođe, literatura je leksikografski sortirana po prezimenima autora.}
...
\odgovor{Podnaslovi su većinski preimenovani u skladu sa sugestijom.}
...
\odgovor{Dodata je naredna rečenica koja detaljnije objašnjava suštinu navedene formule: ``Prvi činilac opisuje \textit{kvalitet alata prema oceni ispitanika}, dok drugi održava njegovu \textit{zastupljenost u uzorku}, čime se favorizuju alati koji su istovremeno dobro ocenjeni i široko korišćeni.''}
...
Uvedene su manje stilske i tehničke izmene:
\begin{itemize}
    \item Grafički prikaz je zamenjen tekstualnim opisom raspodele ispitanika po dužini iskustva, sa procentualnim vrednostima, u poglavlju \textbf{3.2 Struktura uzorka}.

    \item Usaglašene su oznake faktora u poglavlju 4.1.
    Sada se uniformno koriste: 
    ...
    \item Poglavlje 4.4. je preimenovano u \emph{Uticaj navike na zamenu razvojnog alata}.
   
    \item Poglavlje 5.1. je preimenovano u \emph{Poređenje dobijenih rezultata sa literaturom}.
